...
Inherits HTMLElement, Element, Node, EventTarget
  ...
  Property [audioTracks] As AudioTrackList
  '''<Summary></Summary>
  ...
  ReadOnly Property [error] As MediaError
  ...
  ReadOnly Property [textTracks] As TextTrackList
  '''<Summary>Returns the list of VideoTrack objects contained in the element.</Summary>
  ReadOnly Property [videoTracks] As VideoTrackList
