...
'Defined on this type 
  ...
  Sub [enableStyleSheetsForSet]([parname] As Dynamic)
  ...
  Function [getElementsByTagNameNS]([parnamespace As Dynamic, name] As Dynamic) As Element()
  ...
  Function [evaluate]([par
  xpathExpression As Dynamic,
  contextNode As Dynamic,
  namespaceResolver As Dynamic,
  ...
  Function [queryCommandState]([parString command] As Dynamic) As Boolean
