...
'Defined on this type 
  ...
  '''<Summary>Creates and returns a new MediaStream object. You can create an empty stream, a stream which is based upon an existing stream, or a stream that contains a specified list of tracks (specified as an array of MediaStreamTrack objects).</Summary>
  Function [MediaStream]() As MediaStream
  ...
  Function [addTrack]([partrack] As Dynamic, [parstream] As Dynamic) As MediaStream
