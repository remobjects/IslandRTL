...
Public Interface [SVGAnimatedPreserveAspectRatio]
  '''<Summary>Is a SVGPreserveAspectRatio that represents the base value of the given attribute before applying any animations.</Summary>
  ReadOnly Property [baseVal] As SVGPreserveAspectRatio
  ...
  ReadOnly Property [animVal] As SVGPreserveAspectRatio
End Interface