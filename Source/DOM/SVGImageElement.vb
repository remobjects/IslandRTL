...
Inherits SVGGraphicsElement
  ...
  ReadOnly Property [height] As SVGAnimatedLength
  ...
  ReadOnly Property [width] As SVGAnimatedLength
  ...
  ReadOnly Property [x] As SVGAnimatedLength
  ...
  ReadOnly Property [y] As SVGAnimatedLength
