...
'Defined on this type 
  ...
  '''<Summary>The constructor initializes an XMLHttpRequest. It must be called before any other method calls.</Summary>
  Function [XMLHttpRequest]() As XMLHttpRequest
