...
Inherits EventTarget
  ...
  '''<Summary>Obtains an array of information about the media input and output devices available on the system.</Summary>
  Function [enumerateDevices]() As Dynamic
  ...
  Function [getSupportedConstraints]() As MediaTrackSupportedConstraints
